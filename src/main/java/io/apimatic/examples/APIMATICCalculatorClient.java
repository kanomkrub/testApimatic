...
public class APIMATICCalculatorClient {
    ...
    /**
     * Singleton access to Gettripss controller
     * @return	Returns the GettripssController instance 
     */
    public GettripssController getGettripss() {
        return GettripssController.getInstance();
    }
