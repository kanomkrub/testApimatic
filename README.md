...
* [GettripssController](#gettripss_controller)
...
## <a name="gettripss_controller"></a>![Class: ](https://apidocs.io/img/class.png "io.apimatic.examples.controllers.GettripssController") GettripssController

### Get singleton instance

The singleton instance of the ``` GettripssController ``` class can be accessed from the API Client.

```java
GettripssController gettripss = client.getGettripss();
```

### <a name="gettripss_async"></a>![Method: ](https://apidocs.io/img/method.png "io.apimatic.examples.controllers.GettripssController.gettripssAsync") gettripssAsync
...
```java
void gettripssAsync(final APICallBack<Ojseiof> callBack)
```
...
```java
// Invoking the API call with sample inputs
gettripss.gettripssAsync(new APICallBack<Ojseiof>() {
    public void onSuccess(HttpContext context, Ojseiof response) {
        // TODO success callback handler
    }
    public void onFailure(HttpContext context, Throwable error) {
        // TODO failure callback handler
